...
function Atropos(t) {
  ...
  var x,
    ...
    A = function (t) {
      var o = t.rotateXPercentage,
        ...
        s = t.opacityOnly,
        p = t.easeOut;
      $$(e, "[data-atropos-offset], [data-atropos-opacity]").forEach(function (
        t
      ) {
  ...
  return (
    ...
    v &&
      (v.__atropos__ ||
        (void 0 !== h ? "string" == typeof h && (h = $(document, h)) : (h = v),
    ...
    v &&
      ...
      (g.shadow &&
        ((s = $(v, ".atropos-shadow")) ||
          ((s = document.createElement("span")).classList.add("atropos-shadow"),
          (x = !0)),
        _(
          s,
          "translate3d(0,0,-" +
